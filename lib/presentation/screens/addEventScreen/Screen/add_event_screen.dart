                ...
                child: Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      DefaultTextField(
                          controller: cubit.eventTitleController,
                          hintText: '',
                          validator: (validator) {
                            if (validator!.trim() == '') {
                              return '!!';
                      ...
                      defaultButton(
                          onPressed: () {
                            if (formKey.currentState!.validate()) {
                              if (cubit.eventImage == null) {
                                cubit.addEventPost(title: cubit.eventTitleController.text,);
                              } else {
                                cubit.uploadEventImage(title: cubit.eventTitleController.text);
                              }
                            }
                          },
